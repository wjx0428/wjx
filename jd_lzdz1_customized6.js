...
https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=cd20220107vcowv119979tm7p&shareUuid=2db0f8f2861d4be09019a01fc9536bff
*/
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/code/raw/master/lzdz16.json')
    console.log(authorCodeList)
    if($.getAuthorCodeListerr === false){
        authorCodeList = [
            '2db0f8f2861d4be09019a01fc9536bff',
        ]
    }
    // console.log(authorCodeList)
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.activityShopId = '1000016584'
            $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=cd20220107vcowv119979tm7p&shareUuid=${encodeURIComponent($.authorCode)}&adsource=null&shareuserid4minipg=null&shopid=${$.activityShopId}&lng=00.000000&lat=00.000000&sid=&un_area=`
            await member();
            await $.wait(2000)
            if ($.bean > 0) {
