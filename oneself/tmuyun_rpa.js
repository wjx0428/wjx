/*
 ...
 变量：rpaCookie='xxxx@12345678910#abcdefg '  多个账号用 @ 或者 换行 分割
       rpahelpAu = true/false 用于是否助力作者(默认为true)
 定时一天三次
 cron: 10 8,10,19 * * *
 */
 const $ = new Env('融磐安')
 ...
 let cookiesArr = [],
   message = "",
   channelId = ["5d78670b1b011b406fe592b4", "5d8881ae1b011b0c53740a49", "611dc492ad61a462bfb02cdf", "5d8881c3b19850385abefdbe","5d9c448f1b011b4c5ec2c2c8","5d9c449db19850083c1f884c"]
 cookie = ($.isNode() ? process.env.rpaCookie : $.getdata("rpaCookie")) || ``
 ...
 !(async () => {
     ...
     for (let i = 0; i < cookiesArr.length; i++) {
       if (cookiesArr[i]) {
         ...
         console.log(`\n******开始【🐳融磐安账号${$.index}】${$.nickName}|${$.mobile}*********\n`);
         await main()
       }
     }
     if ($.isNode() && message) {
  ...
  */
  async function credential_auth() {
   let url = {
     ...
     body: `client_id=45&password=${encodeURIComponent($.pwd)}&phone_number=${$.mobile}`,
     headers: {
