...
https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=cd20220108iu890dmnhimj01ied&shareUuid=e940a5209e4a48d3ba08a36ce788f37e
*/
const $ = new Env("集年味卡 享年味盛典");
...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/code/raw/master/lzdz15.json')
    // console.log(authorCodeList)
    if($.getAuthorCodeListerr === false){
        authorCodeList = [
            'e940a5209e4a48d3ba08a36ce788f37e',
        ]
    }
    // console.log(authorCodeList)
